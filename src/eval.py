...
def eval(args):
    if args.node=='U':
        true_label_fpath = '../datasets/'+args.data+'/Label_U.txt'
    else:
        true_label_fpath = '../datasets/'+args.data+'/Label_V.txt'
...
def main():
    ...
    parser.add_argument('--algo', default='KM',
                        help='method name.')

    parser.add_argument('--node', default='U', help='node type.')
